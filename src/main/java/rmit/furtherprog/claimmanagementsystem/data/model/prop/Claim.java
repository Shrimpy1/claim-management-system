...
public class Claim {
    ...
    public Claim(LocalDate claimDate, Customer insuredPerson, String cardNumber, LocalDate examDate, List<String> documents, double claimAmount, BankingInfo receiverBankingInfo) {
